	...
	if(isset($_POST['submit']))
{
   ...
   $d=$_POST['des'];
	 $url=$_POST['url'];
$insrt="insert into classlinks(cid,title,description,tid,link)values('','$t','$d','$id','$url')";
$a=mysqli_query($con,$insrt);
 if($a)
	{
	header("location:uploadlink.php");
}
}
?>
<!DOCTYPE html>
			...
			<div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						...
						<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.html">Upload links</a></p>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
                  ...
                  <form class="form-area contact-form text-right"  method="POST">
                        ...
                        <textarea class="common-textarea form-control" name="des" placeholder="Enter Description" onFocus="this.placeholder = ''" onBlur="this.placeholder = 'Enter Description'" required=""></textarea><br>
  											<input  class="common-input mb-20 form-control" type="url" name="url" placeholder="Enter the link ">
                        	<button class="primary-btn text-uppercase mt-20" name="submit">Upload</button>
                  		</form>
								</div>
