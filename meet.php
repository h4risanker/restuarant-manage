				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">Study Materials </h1>	
						</div>	
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row">
						<div id="buttons" >
										...
										$sql="SELECT title,description,link FROM classlinks INNER JOIN tutor on classlinks.tid=tutor.id INNER JOIN student on tutor.classid=student.classid AND student.id='$id'";
										$conn=mysqli_query($con,$sql);
												while($row = mysqli_fetch_array($conn)){

			echo '<h3 class="label-heading" >' . '<a href="' . $row['link'] . '">' .   $row['title'] . '</a>' . '</h3>' . '<br/>';
												echo '<h5>' .$row['description']. '<h5>'.'<br/>';
										}
										?>
