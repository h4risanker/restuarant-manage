				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.html"> Student Requests</a></p>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="contact-page-area section-gap">
				<div class="container">
					<div class="row">
						...
						<th width="25%"><center>Student Email</center></th>
						<th width="20%"><center>Student Number</center></th>
						<th width="20%"><center>Student Address</center></th>
						<th width="20%"><center>Approve</center></th>
						<th width="20%"><center>Reject</center></th>
						</tr>
						<?php
						$slno=1;
