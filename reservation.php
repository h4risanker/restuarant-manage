  ...
  if(isset($_POST['submit']))
{
   ...
   $d=$_POST['email'];
   $m=$_POST['message'];
$insrt="insert into message(mid,sid,name,email,message)values('','$id','$t','$d','$m')";
      ...
      <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
          <div class="about-content col-lg-12">
            ...
            <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="menu.html">contact</a></p>
          </div>
        </div>
      </div>
    </section>
