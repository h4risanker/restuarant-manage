				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								Approved Students </h1>
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.html"> Approved Students</a></p>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="contact-page-area section-gap">
				<div class="container">
					<div class="row">
						...
						<?php
						$slno=1;
						while($r1=mysqli_fetch_array($coonn))
						{
						?>
						<tr>
						<td><?php echo $slno; ?></td>
						...
						<td><button class="primary-btn text-uppercase mt-20" name="submit" onClick="reject(<?Php echo $r1['id'];?>)" >Delete</button></td>
						</tr>
						<?Php
						$slno++;
						}
